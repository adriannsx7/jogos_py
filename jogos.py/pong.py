...
# Processa eventos
    ...
    tela.fill(preto)
    pygame.draw.rect(tela, azul, (10, raquete esquerda_y, raquete_largura, raquete_altura)) # Raquete esquerda azul 
    pygame.draw.rect(tela, verde, (largura 20, raquete direita_y, raquete largura, raquete_altura)) #Raquete direita verde
    pygame.draw.ellipse(tela, amarelo, (bola x, bola y, 10, 10)) # Bola amarela
